        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <FadeInUp>
            <div className="bg-blue-500 rounded-2xl p-8 h-full flex items-center justify-between gap-4">
              ...
              <img src="/img/Self.png" alt="" className="w-13 h-13 shrink-0" />
            </div>
          </FadeInUp>

          <FadeInUp>
            <div className="bg-blue-800 rounded-2xl p-8 h-full flex items-center justify-between gap-4">
              <div>
          ...
          <FadeInUp>
        <div className="text-center text-lg md:text-sm text-white font-light tracking-wide leading-loose mt-20 mb-12">
  ...
  const text = (
    <FadeInUp>
      ...
      <div className="flex items-center gap-2 text-sm text-neutral-400 mb-1">
        <img src="/img/place.png" alt="" className="w-4 h-5" />
        {location}
      </div>
...
function Activities() {
  return (
    <section className="bg-[#1e1e1e]">
      ...
      <FadeInUp>
        <p className="text-blue-300 font-semibold text-center pt-16 pb-2">
          @2026 PROGRAM info
        </p>
      </FadeInUp>
      <ActivityItem
